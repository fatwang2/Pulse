...
- **Watchlists** supporting US stocks, Hong Kong stocks, China A-shares, cryptocurrencies, indices, and ETFs — organize symbols into named lists, pin favorites per list, and reorder them with native drag and drop
